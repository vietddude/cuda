...
test_cpu: test_cpu.o
	...
	nvcc -arch=sm_75 -o test_cpu -lm -lcuda -lrt test_cpu.o src/network.o src/mnist.o src/layer/*.o src/loss/*.o src/optimizer/*.o src/layer/kernel/kernel.o -I./ -L/usr/local/cuda/lib64 -lcudart
